...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (counsel zygospore helm-gtags helm yasnippet ws-butler volatile-highlights use-package undo-tree iedit dtrt-indent counsel-projectile company clean-aindent-mode anzu))))
(custom-set-faces
...
(setq whitespace-style '(face trailing tabs)) ;; Show trailing whitespaces
...
(set-frame-font "Roboto Mono:style=Regular")
